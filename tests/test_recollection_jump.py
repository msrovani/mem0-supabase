...
class TestRecollectionEngine(unittest.TestCase):
    ...
    def test_recollect_with_graph_jump(self):
        ...
        initial_relations = [{"source": "QueryUser", "relation": "searched", "target": "Sports"}]

        self.mock_memory.search.return_value = {"results": mock_memories, "relations": initial_relations}
