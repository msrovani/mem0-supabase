        ...
        return [
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "metadata": {"type": "object", "description": "Optional metadata (tags, categories, etc.)"},
                    },
            ...
            },
            {
                ...
                "inputSchema": {
                    "type": "object",
                    "properties": {"memory_id": {"type": "string", "description": "Memory UUID to delete"}},
                    "required": ["memory_id"],
                },
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "user_id": {"type": "string", "description": "User identifier"},
                        "days_ago": {"type": "integer", "description": "How many days in the past to query"},
                    },
        ...
        try:
            if name == "memories_add":
                result = self.memory.add(
                    arguments["content"], user_id=arguments["user_id"], metadata=arguments.get("metadata", {})
                )
                return {"success": True, "result": result}

            elif name == "memories_search":
                results = self.memory.search(
                    arguments["query"], user_id=arguments["user_id"], limit=arguments.get("limit", 5)
                )
                return {"results": results}

            elif name == "memories_list":
                results = self.memory.get_all(user_id=arguments["user_id"], limit=arguments.get("limit", 20))
                ...
                results = self.temporal.get_memories_at(arguments["user_id"], days_ago=arguments["days_ago"])
