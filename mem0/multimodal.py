    ...
    def add_image(
        ...
        try:
            ...
            self.supabase.storage.from_(bucket_name).upload(
                path=file_path, file=file_obj, file_options={"content-type": "image/jpeg", "upsert": "true"}
            )
        ...
        final_metadata.update(
            {"asset_url": public_url, "asset_type": "image", "file_path": file_path, "multimodal": True}
        )
